...
//@input int colorProperty = 0 {"widget":"combobox", "values":[{"label":"Default", "value":0}, {"label":"Outline (Text Only)", "value":1}, {"label":"Drop Shadow (Text Only)", "value":2}]}
...
var ColorProperty = {"Default": 0, "TextOutline": 1, "TextDropShadow": 2}
...
function getVisualComponentEndColor(visualComponent, startValue){
    if(visualComponent.getTypeName() == "Component.Text"){        
        var textSetting = visualComponent.textFill;
        if(script.colorProperty == ColorProperty.TextOutline){
            textSetting = visualComponent.outlineSettings.fill;
        }
        else if(script.colorProperty == ColorProperty.TextDropShadow){
            textSetting = visualComponent.dropshadowSettings.fill;
        }
